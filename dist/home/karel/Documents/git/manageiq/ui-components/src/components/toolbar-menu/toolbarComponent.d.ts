...
export declare class ToolbarController {
    ...
    constructor($window: ng.IWindowService, $location: ng.ILocationService, $sce: ng.ISCEService);
    /**
     ...
     */
    hasContent(toolbarItem: Array<IToolbarItem>): boolean;
    /**
     ...
     */
    trustAsHtml(escapedString: string): any;
    /**
     ...
     */
    private static htmlDecode(input);
    /**
     ...
     */
    private static isButtonOrSelect(item);
    /**
     ...
     */
    private static isButtonSelect(item);
    /**
