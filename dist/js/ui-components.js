...
Object.defineProperty(exports, "__esModule", { value: true });
var services_1 = __webpack_require__(81);
var filters_1 = __webpack_require__(77);
var components_1 = __webpack_require__(73);
var angular = __webpack_require__(1);
var gtl;
(function (gtl) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var siteSwitcherComponent_1 = __webpack_require__(82);
var angular = __webpack_require__(1);
var siteSwitcher;
...
Object.defineProperty(exports, "__esModule", { value: true });
var services_1 = __webpack_require__(89);
...
(function (topologyGraph) {
    topologyGraph.app = angular.module('miqStaticAssets.topologyGraph', []);
    services_1.default(topologyGraph.app);
    components_1.default(topologyGraph.app);
...
module.exports = "<div class=\"miq-topology-graph\">\n  <div class=\"miq-topology-filters btn-group\">\n    <button type=\"button\" ng-class=\"[!item.active && 'active', 'btn', 'btn-default']\" ng-repeat=\"item in $ctrl.filters\" ng-click=\"$ctrl.toggleFilter(item);\">\n      <i class=\"{{ item.icon }}\"></i>\n    </button>\n  </div>\n  <canvas class=\"topology-graph\"></canvas>\n  <div class=\"topology-tooltip tooltip right in\" ng-class=\"(!$ctrl.tooltip || $ctrl.menu) && 'hidden'\" ng-style=\"$ctrl.tooltipStyle()\">\n    <div class=\"tooltip-arrow\"></div>\n    <div class=\"tooltip-inner\">{{ $ctrl.tooltip.id }}</div>\n  </div>\n  <div class=\"topology-menu dropdown open\" ng-class=\"!$ctrl.menu && 'hidden'\" ng-style=\"$ctrl.menuStyle()\">\n    <ul class=\"dropdown-menu\">\n      <li class=\"no-hover\"><a href ng-click=\"$event.stopPropagation();\"><strong>Actions on {{ $ctrl.menu.id }}</strong></a></li>\n      <li role=\"separator\" class=\"divider\"></li>\n      <li><a href ng-click=\"$ctrl.summaryScreen();\">Summary screen</a></li>\n    </ul>\n  </div>\n  <div class=\"hidden\" ng-transclude></div>\n</div>\n"
    ...
    TabListController.prototype.$onInit = function () {
        ...
        this.sortableOptions = {
            ...
            stop: function (e, ui) {
                ...
                var tabList = sortedTab.$parent.vm.tabList;
...
Object.defineProperty(exports, "__esModule", { value: true });
var dataTableComponent_1 = __webpack_require__(71);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var data_table_1 = __webpack_require__(72);
var tile_view_1 = __webpack_require__(74);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var tileViewComponent_1 = __webpack_require__(76);
var pagingComponent_1 = __webpack_require__(75);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var tileType_1 = __webpack_require__(79);
var abstractDataViewClass_1 = __webpack_require__(5);
var _ = __webpack_require__(0);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var limitToSuffixFilter_1 = __webpack_require__(78);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var dataTableService_1 = __webpack_require__(80);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var toolbar_menu_1 = __webpack_require__(84);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var toolbarComponent_1 = __webpack_require__(86);
var toolbarButtonDirective_1 = __webpack_require__(85);
var toolbarListComponent_1 = __webpack_require__(87);
var toolbarViewComponent_1 = __webpack_require__(88);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var toolbarSettingsService_1 = __webpack_require__(90);
exports.default = function (module) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var topology_graph_1 = __webpack_require__(94);
var topology_filter_1 = __webpack_require__(92);
exports.default = function (module) {
    topology_graph_1.default(module);
    topology_filter_1.default(module);
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var topologyFilterComponent_1 = __webpack_require__(93);
exports.default = function (module) {
    module.component('miqTopologyFilter', new topologyFilterComponent_1.default);
};
 ...
 */
var TopologyFilterController = (function () {
    function TopologyFilterController() {
    }
    TopologyFilterController.prototype.$onInit = function () {
    ...
    return TopologyFilterController;
}());
var TopologyFilter = (function () {
    function TopologyFilter() {
        this.controller = TopologyFilterController;
        this.require = {
...
exports.default = TopologyFilter;
...
Object.defineProperty(exports, "__esModule", { value: true });
var topologyGraphComponent_1 = __webpack_require__(95);
exports.default = function (module) {
    module.component('miqTopologyGraph', new topologyGraphComponent_1.default);
};
 ...
 */
var TopologyGraphController = (function () {
    /*@ngInject*/
    TopologyGraphController.$inject = ["MiQTopologyGraphService", "$element", "$scope"];
    function TopologyGraphController(MiQTopologyGraphService, $element, $scope) {
        this.MiQTopologyGraphService = MiQTopologyGraphService;
        this.$element = $element;
        this.$scope = $scope;
        this.filters = [];
    }
    TopologyGraphController.prototype.addFilter = function (filter) {
        this.filters.push(filter);
    };
    TopologyGraphController.prototype.toggleFilter = function (filter) {
        filter.active = !filter.active;
        // Fetch a list of node types that should be hidden
        var toHide = _.filter(this.filters, function (f) { return f.active; }).map(function (f) { return f.type; });
        // Filter out the nodes that shouldn't be displayed
        var nodes = _.filter(this.nodes, function (node) { return !toHide.includes(node.type); });
        // Filter out the links that are connected to hidden nodes
        var links = _.filter(this.links, function (link) { return nodes.includes(link.source) && nodes.includes(link.target); });
        // Restart the simulation
        this.MiQTopologyGraphService.restartSimulation(this.simulation, nodes, links);
    };
    TopologyGraphController.prototype.tooltipStyle = function () {
        if (this.tooltip) {
            return {
    ...
    TopologyGraphController.prototype.menuStyle = function () {
        if (this.menu) {
            return {
    ...
    TopologyGraphController.prototype.$onInit = function () {
        var _this = this;
        ...
        this.simulation = d3.forceSimulation()
            ...
            .force('collision', d3.forceCollide(function (d) { return d.size || 17; }))
        ...
        this.MiQTopologyGraphService.httpGet(this.url).then(function (d) { return _this.fetchData(d); }).then(function () {
            _this.simulation.nodes(_this.nodes).on('tick', function () { return _this.forceTick(); });
            _this.simulation.force('link').links(_this.links);
            // Set up dragging
            d3.select(_this.canvas).call(d3.drag().container(_this.canvas)
                .subject(function () { return _this.findNode(d3.event.x, d3.event.y); })
                .on('start', function () { return _this.onDragStart(); })
                .on('drag', function () { return _this.onDrag(); })
                .on('end', function () { return _this.onDragEnd(); }));
            // Set up pan & zoom
            d3.select(_this.canvas).call(d3.zoom()
                .translateExtent([[0, 0], [_this.canvasW, _this.canvasH]])
                .scaleExtent([1, 8])
                .on('zoom', _this.onZoom.bind(_this)));
            // Set up tooltips
            d3.select(_this.canvas).on('mousemove', function () {
                _this.tooltip = _this.findNode(d3.event.x - _this.canvasX, d3.event.y - _this.canvasY);
                _this.$scope.$apply();
            });
            // Set up context menu
            d3.select(_this.canvas).on('contextmenu', function () {
                d3.event.preventDefault();
                // Items have an explicit false for disabled context menu
                if (_this.tooltip.menu !== false) {
                    _this.menu = _this.menu ? undefined : _this.tooltip;
                    _this.$scope.$apply();
                }
            });
            d3.select(_this.canvas).on('click', function () {
                _this.menu = undefined;
                _this.$scope.$apply();
            });
        });
    };
    TopologyGraphController.prototype.fetchData = function (data) {
        this.nodes = data.nodes;
        this.links = data.links;
        this.icons = data.icons;
        this.maxNodeSize = Math.max.apply(Math, this.nodes.map(function (d) { return d.size || 17; }));
        return this.MiQTopologyGraphService.loadIcons(this.icons);
    };
    TopologyGraphController.prototype.normalizeNode = function (node) {
    ...
    TopologyGraphController.prototype.drawNode = function (node) {
        this.context.beginPath();
        // Create the circle
        (_a = this.context).arc.apply(_a, this.transform.apply([node.x, node.y]).concat([node.size, 0, 2 * Math.PI]));
        ...
        var coords = this.transform.apply([node.x, node.y]);
        ...
        if (icon.char && icon.font) {
            ...
            (_b = this.context).fillText.apply(_b, [icon.char].concat(coords));
        }
        else if (icon.img) {
            (_c = this.context).drawImage.apply(_c, [icon.img].concat(coords.map(function (r) { return r - imgR; }), [2 * imgR, 2 * imgR]));
        }
        var _a, _b, _c;
    };
    TopologyGraphController.prototype.drawLink = function (link) {
        this.context.beginPath();
        (_a = this.context).moveTo.apply(_a, this.transform.apply([link.source.x, link.source.y]));
        (_b = this.context).lineTo.apply(_b, this.transform.apply([link.target.x, link.target.y]));
        this.context.strokeStyle = 'rgba(150, 150, 150, 0.6)';
        this.context.stroke();
        var _a, _b;
    };
    TopologyGraphController.prototype.drawMinimap = function () {
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(0, 0, 0, 0.3)';
        this.context.fillStyle = 'rgba(252, 252, 252, 0.3)';
        var mapX = 0.9 * this.canvasW - 10, mapY = 10, mapW = 0.1 * this.canvasW, mapH = 0.1 * this.canvasH;
        this.context.rect(mapX, mapY, mapW, mapH);
        this.context.stroke();
        this.context.fill();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(224, 224, 224, 0.3)';
        this.context.rect(mapX - this.transform.x / this.transform.k * 0.1, mapY - this.transform.y / this.transform.k * 0.1, mapW / this.transform.k, mapH / this.transform.k);
        this.context.stroke();
        this.context.fill();
    };
    TopologyGraphController.prototype.forceTick = function () {
    ...
    TopologyGraphController.prototype.findNode = function (x, y) {
        var point = this.transform.invert([x, y]);
        var node = (_a = this.simulation).find.apply(_a, point.concat([this.maxNodeSize]));
        return node ? (_b = this.simulation).find.apply(_b, point.concat([node.size])) : undefined;
        var _a, _b;
    };
    TopologyGraphController.prototype.onDragStart = function () {
        if (!d3.event.active) {
    ...
    TopologyGraphController.prototype.onDrag = function () {
    ...
    TopologyGraphController.prototype.onDragEnd = function () {
        if (!d3.event.active) {
    ...
    TopologyGraphController.prototype.onZoom = function () {
        if (d3.event !== null) {
    ...
    return TopologyGraphController;
}());
exports.TopologyGraphController = TopologyGraphController;
var TopologyGraph = (function () {
    function TopologyGraph() {
        this.controller = TopologyGraphController;
...
Object.defineProperty(exports, "__esModule", { value: true });
var topologyGraphService_1 = __webpack_require__(97);
exports.default = function (module) {
    module.service('MiQTopologyGraphService', topologyGraphService_1.default);
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var TopologyGraphService = (function () {
    /*@ngInject*/
    TopologyGraphService.$inject = ["$http", "MiQEndpointsService"];
    function TopologyGraphService($http, MiQEndpointsService) {
        this.$http = $http;
        this.MiQEndpointsService = MiQEndpointsService;
    }
    /**
     ...
     */
    TopologyGraphService.prototype.httpGet = function (url) {
        return this.$http.get(url)
            .then(function (dataResponse) { return dataResponse.data; });
    };
    TopologyGraphService.prototype.loadIcons = function (icons) {
        ...
        Object.keys(icons).map(function (key) { return icons[key]; }).map(function (icon) {
            if (icon.type === 'fonticon') {
                ...
                promises.push(new Promise(function (resolve, reject) {
                    ...
                    icon.img.onload = function () { return resolve(); };
                }));
            }
            return icon;
        });
    ...
    TopologyGraphService.prototype.restartSimulation = function (simulation, nodes, links) {
        simulation.nodes(nodes);
        simulation.force('link').links(links);
        simulation.alpha(1).restart();
    };
    TopologyGraphService.prototype.findNode = function (sim, trans, r, x, y) {
        var point = trans.invert([x, y]);
        var node = sim.find.apply(sim, point.concat([r]));
        return node ? sim.find.apply(sim, point.concat([node.size])) : undefined;
    };
    return TopologyGraphService;
}());
exports.default = TopologyGraphService;
...
var map = {
	"./check-box.html": 28,
	"./date-time-control.html": 29,
	"./dynamic.html": 30,
	"./index": 2,
	"./index.ts": 2,
	"./modalFieldTemplateComponent": 3,
	"./modalFieldTemplateComponent.ts": 3,
	"./radio-button-drop-down-list.html": 31,
	"./tag-control.html": 32,
	"./text-area-box.html": 33,
	"./text-box.html": 34
};
