...
var ModalFieldTemplate = (function () {
    function ModalFieldTemplate() {
        this.template = function (tElement, tAttrs) {
            return __webpack_require__(81)("./" + tAttrs.template);
        };
...
var modalFieldTemplateComponent_1 = __webpack_require__(2);
Object.defineProperty(exports, "__esModule", { value: true });
...
var filters_1 = __webpack_require__(67);
...
var siteSwitcherComponent_1 = __webpack_require__(72);
var angular = __webpack_require__(1);
var siteSwitcher;
...
var BoxController = (function () {
    ...
    BoxController.prototype.$onInit = function () {
        ...
        this.sortableOptionsBox = {
            ...
            stop: function (e, ui) {
                ...
                this.DialogEditor.updatePositions(sortedBox.$parent.tab.dialog_groups);
            },
        };
        ...
        this.sortableOptionsFields = {
            ...
            stop: function (e, ui) {
                ...
                this.DialogEditor.updatePositions(sortedField.$parent.box.dialog_fields);
            },
        };
    };
    /**
    ...
    BoxController.prototype.removeBox = function (id) {
        _.remove(this.dialogTabs[this.DialogEditor.activeTab].dialog_groups, function (box) {
    ...
    BoxController.prototype.droppableOptions = function (e, ui) {
        ...
        // update indexes of other boxes after changing their order
        this.DialogEditor.updatePosition(droppedItem.box.dialog_fields);
    };
    /**
...
var TabListController = (function () {
    ...
    TabListController.prototype.removeTab = function (id) {
        ...
        _.remove(this.tabList, function (tab) {
...
var ModalController = (function () {
    ...
    function ModalController(dialogDetails, $uibModalInstance, CollectionsApi, DialogEditor) {
        ...
        switch (this.element) {
            case 'tab':
                this.modalData = _.cloneDeep(this.DialogEditor.getDialogTabs()[this.DialogEditor.activeTab]);
                break;
            case 'box':
                this.modalData = _.cloneDeep(this.DialogEditor.getDialogTabs()[this.DialogEditor.activeTab].dialog_groups[this.dialog.boxId]);
                break;
            case 'field':
                this.modalData = _.cloneDeep(this.DialogEditor.getDialogTabs()[this.DialogEditor.activeTab].dialog_groups[this.dialog.boxId].dialog_fields[this.dialog.fieldId]);
    ...
    ModalController.prototype.deleteField = function () {
        _.remove(this.DialogEditor.getDialogTabs()[this.DialogEditor.activeTab].dialog_groups[this.dialog.boxId].dialog_fields, function (field) {
...
var EditDialogService = (function () {
    /** @ngInject */
    EditDialogService.$inject = ["$uibModal"];
    function EditDialogService($uibModal) {
     ...
     */
    EditDialogService.prototype.showModal = function (tab, box, field) {
        var modalOptions = {
...
var dataTableComponent_1 = __webpack_require__(61);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var data_table_1 = __webpack_require__(62);
var tile_view_1 = __webpack_require__(64);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var tileViewComponent_1 = __webpack_require__(66);
var pagingComponent_1 = __webpack_require__(65);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var tileType_1 = __webpack_require__(69);
var abstractDataViewClass_1 = __webpack_require__(5);
var _ = __webpack_require__(0);
/**
...
var limitToSuffixFilter_1 = __webpack_require__(68);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var dataTableService_1 = __webpack_require__(70);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var toolbar_menu_1 = __webpack_require__(74);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var toolbarComponent_1 = __webpack_require__(76);
var toolbarButtonDirective_1 = __webpack_require__(75);
var toolbarListComponent_1 = __webpack_require__(77);
var toolbarViewComponent_1 = __webpack_require__(78);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
...
var toolbarSettingsService_1 = __webpack_require__(80);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function (module) {
