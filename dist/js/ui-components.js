...
/***/ function(module, exports) {
	...
	var DataTableService = (function () {
	     ...
	     */
	    DataTableService.prototype.retrieveRowsAndColumnsFromUrl = function (modelName, activeTree, currId, settings) {
	        var _this = this;
	        return this.fetchData(DataTableService.generateConfig(modelName, activeTree, currId, settings))
	     ...
	     */
	    DataTableService.generateConfig = function (modelName, activeTree, currId, settings) {
	        var config = { params: {} };
